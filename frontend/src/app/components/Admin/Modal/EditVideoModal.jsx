...
export default function EditVideoModal({ onClose, onSubmit, id }) {
    // ประกาศฟังก์ชันคอมโพเนนต์ EditVideoModal ที่รับ props คือ
    // onClose - ฟังก์ชันสำหรับปิด modal
    // onSubmit - ฟังก์ชันสำหรับส่งข้อมูลเมื่อแก้ไขเสร็จ
    // id - รหัสผู้ใช้ที่จะแก้ไขข้อมูล

    const [video, setVideo] = useState({ VideoName: "", VideoURL: "" });
            ...
            <div className="relative bg-white rounded-xl p-6 w-full max-w-md shadow-2xl animate-fade-in-up">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <input
                        ...
                        // อัปเดตค่า VideoName ใน state ทุกครั้งที่มีการพิมพ์ใน input
                        required
                    ...
                    <div>
                        ...
                        {video.VideoURL && (
                            ...
                            {renderVideoPreview(video.VideoURL)}
                            </div>
                        )}
                    </div>
                    {/* ช่องกรอก VideoURL */}
